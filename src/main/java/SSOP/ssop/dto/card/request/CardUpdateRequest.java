...
public class CardUpdateRequest {
    ...
    public CardStudentUpdateRequest getStudent() {
        return student;
    }

    public void setStudent(CardStudentUpdateRequest student) {
        this.student = student;
    }

    public CardWorkerUpdateRequest getWorker() {
        return worker;
    }

    public void setWorker(CardWorkerUpdateRequest worker) {
        this.worker = worker;
    }
}
